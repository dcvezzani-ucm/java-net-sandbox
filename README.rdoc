...
# git clone https://github.com/dcvezzani-ucm/java-net-sandbox.git
# start Eclipse
# create or select a workspace in which to place the project
# in terminal window, go to directory of selected workspace
# import "Existing Projects into Workspace"

== Start

# in "Package Explorer" pane, select "user-inactivate-client" and expand
# locate and open "src/test/java/edu/ucmerced/box/client/Sandbox.java"
